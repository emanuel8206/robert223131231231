...
function drawHUD()
	...
	if active and not isPlayerMapVisible() and not estadohud or estadohud == true then
		...
		if dutyPol == true then
			dxDrawImage(ax,ay,32,37,"images/new/badge5.png")
			ax = ax - 34
		end
		local dutymed = getElementData(localPlayer, "dutymd")
		if dutymed == true then
			dxDrawImage(ax,ay,32,37,"images/new/badge3.png")
			ax = ax - 34
		end
		local dutymeca = getElementData(localPlayer, "dutymeca")
		if dutymeca == true then
			dxDrawImage(ax,ay,32,37,"images/new/badge4.png")
			ax = ax - 34
		end
		local dutygob = getElementData(localPlayer, "dutygob")
		if dutygob == true then
			dxDrawImage(ax,ay,32,37,"images/new/badge7.png")
			ax = ax - 34
		end
		local dutyjus = getElementData(localPlayer, "dutyjus")
		if dutyjus == true then
			dxDrawImage(ax,ay,32,37,"images/new/badge6.png")
			ax = ax - 34
		end
